...
type SessionConfig struct {
	...
	SourceAddress   string   // Local source address for BGP (link-local)
	Extensions      []string // BGP extensions: mp_bgp, extended_nexthop
